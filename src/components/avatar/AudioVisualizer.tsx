...
export function AudioVisualizer({ amplitude }: AudioVisualizerProps) {
  ...
  return (
    <div className="absolute bottom-5 left-1/2 flex -translate-x-1/2 items-end gap-1 rounded-full border border-slate-400/15 bg-slate-800/45 px-4 py-3 backdrop-blur-xl">
      {bars.map((bar) => {
